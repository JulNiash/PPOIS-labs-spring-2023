...
class RemoveByTournamentNameOrDateWindow(QMainWindow):
    ...
    def __init__(self, parent=None, tournament_list=[]):
        ...
        self.name_line.resize(100, 30)
        self.name_line.move(100, 30)
        ...
        self.date_edit = QDateEdit(self, calendarPopup=True)
        self.date_edit.dateTimeChanged.connect(self.update)
        self.date_edit.move(100, 90)

        self.button = QPushButton('Удалить турниры', self)
        self.button.resize(100, 30)
        self.button.move(100, 140)
        self.button.clicked.connect(self.the_button_was_clicked)
...
class RemoveByWinnerNameOrSportNameWindow(QMainWindow):
    ...
    def __init__(self, parent=None, tournament_list=[]):
        ...
        self.sport_name_line = QLineEdit(self)
        self.sport_name_line.resize(100, 30)
        self.sport_name_line.move(100, 30)
        ...
        self.winner_name_line = QLineEdit(self)
        self.winner_name_line.resize(100, 30)
        self.winner_name_line.move(100, 90)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.table = QTableWidget(self)
        self.table_row = 0
        self.table.move(0, 210)
        self.table.resize(size_x, int(size_y-210))
        self.table.setColumnCount(6)
        ...
        self.add_button.resize(size_x, 30)
        ...
        self.remove_by_tname_or_date_button.resize(size_x, 30)
        self.remove_by_tname_or_date_button.move(0, 30)
        ...
        self.remove_by_wname_or_sname_button = QPushButton('Удалить турниры по названию спорта или имени победителя', self)
        self.remove_by_wname_or_sname_button.resize(size_x, 30)
        self.remove_by_wname_or_sname_button.move(0, 60)
        ...
        self.remove_by_pmoney_or_wmoney_button = QPushButton('Удалить турниры по общим призовым или призовым победителя', self)
        self.remove_by_pmoney_or_wmoney_button.resize(size_x, 30)
        self.remove_by_pmoney_or_wmoney_button.move(0, 90)
        ...
        self.find_by_tname_or_date_button.resize(size_x, 30)
        self.find_by_tname_or_date_button.move(0, 120)
        ...
        self.find_by_wname_or_sname_button = QPushButton('Найти турниры по названию спорта или имени победителя',self)
        self.find_by_wname_or_sname_button.resize(size_x, 30)
        self.find_by_wname_or_sname_button.move(0, 150)
        ...
        self.find_by_pmoney_or_wmoney_button = QPushButton('Найти турниры по общим призовым или призовым победителя', self)
        self.find_by_pmoney_or_wmoney_button.resize(size_x, 30)
        self.find_by_pmoney_or_wmoney_button.move(0, 180)
